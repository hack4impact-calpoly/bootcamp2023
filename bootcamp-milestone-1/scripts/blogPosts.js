...
function addPostToDOM(blogPostObj, clickable) {
    ...
    if (clickable) {
        ...
        blogPost.classList.add("blog-post-no-click");
    }
    if (clickable) {
    ...
    var blogPostTitleDate = document.createElement("div");
    ...
    var blogPostMessage = document.createElement("p");
    ...
    blogPostsContainer === null || blogPostsContainer === void 0 ? void 0 : blogPostsContainer.appendChild(blogPost);
}
function addSinglePostToDOM(index) {
    addPostToDOM(blogPostsObj[index], false);
}
function addTildaToDOM() {
    var blogPostsContainer = document.getElementById("blog-posts");
    var blogPostTilda = document.createElement("h1");
    blogPostTilda.classList.add("blog-post-tilda");
    blogPostTilda.innerHTML = "~";
    blogPostsContainer === null || blogPostsContainer === void 0 ? void 0 : blogPostsContainer.appendChild(blogPostTilda);
}
function createBlogElements() {
    for (var i = 0; i < blogPostsObj.length; i++) {
