      ...
      <div className={styles.blog}>
        <div className={styles.blogInnerContainer}>
          ...
          <div className={styles.blogPosts} id="blog-posts">
            {blogData ? blogData.map((blogPostObj) => (
                ...
                >
                  <div className={styles.blogPost}>
                    <div className={styles.blogPostTitleDate}>
                      ...
                      <p className="blogPostDate">{String(blogPostObj.date)}</p>
                    </div>
                    <p className="blogPostMessage">{blogPostObj.description}</p>
                  </div>
                </Link>
                {blogPostObj.blogNum != 1 ? <h1 className={styles.blogPostTilda}>~</h1> : null}
              </div>
            )) : null}
          </div>
        </div>
