    ...
    return (
      <section className={style.mainContainer}>
        ...
        <section className={style.subSection}>
          ...
          <br></br>
          <p>Throught the process, it was imporant to perform various voltage readings using a multimeter to the electrical components are functional. Doing this required care as it could be easy to cause a short</p>         
          <div className={style.imageContainer}>
            <img src={PCB.src}></img>
