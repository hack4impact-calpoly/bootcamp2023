...
export default function BlogPreview(props: Blog) {
  ...
  return (
    ...
    <div key={props.slug} className={style.blog_post}>
				<Image className={style.blog_image} src={props.image} alt={props.image_alt} width={width} height={height}></Image>
        <div className={style.blog_content}>
            <Link className={style.blog_link} href={"/blog/" + props.slug}> <h1 className={style.blog_title}>{props.title}</h1> </Link>
