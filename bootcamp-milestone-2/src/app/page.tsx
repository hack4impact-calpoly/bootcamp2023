  ...
  return (<div>
            ...
            <div className={style.about}>
                ...
                <div className={style["about-text"]}>
                    ...
                    <p>This year, I am excited to further explore the realm of computing, with all its intricate challenges. Furthermore, I'm <em>incredibly</em> enthusiastic about the prospect of creating meaningful projects with H4I this year!</p>
                </div>
