  ...
  return (<div>
		 <main>
            ...
            <div className={Style["projects"]}>
                <Image src="/images/website.png" alt="picture of website homepage" width="500" height="500"/>
                <div className={Style["project-details"]}>
                    ...
                    <a href="https://github.com/jam-kt/PacMan"> <Image src="/images/pacman.png" alt="screenshot from pacman project showing gameplay" width="500" height="500"/> </a>
                    <div className={Style["project-details"]}>
                ...
                <Image src="/images/basys.jpg" alt="stock image of a basys3 FPGA board" width="500" height="500"/>
                <div className={Style["project-details"]}>
