            ...
            <div className={style.resume}>
              <section className={style.section}>
                ...
                <div className={style.entry}>
                  <h3 className={style.entryTitle}>
                    Bachelor of Science in Computer Science, Concentration in AI
              ...
              <section className={style.section}>
                ...
                <div className={style.entry}>
                  ...
                  <ul className={style.entryDescription}>
                    <li>
                      Optimizes strategies for music theory, economics,
                      statistics, chemistry, mathematics, and IB course concepts
                    </li>
                    <li>
                    ...
                    <li>
                      Utilizes data analysis and client acquisition management
                      to develop customer retention by 160%
                    </li>
                    <li>
                ...
                <div className={style.entry}>
                  ...
                  <ul className={style.entryDescription}>
                    <li>
                      ...
                      insurance eligibility and appointment confirmation,
                      billing, verifying insurance disbursements, and organizing
                      expenses, increasing secretarial productivity by 150%
                    </li>
                    <li>
                      Develops Python program to parse 2+ disbursement files
                      into a readable database, enhancing efficiency by 268%
                    </li>
                    <li>
                ...
                <div className={style.entry}>
                  ...
                  <ul className={style.entryDescription}>
                    <li>
                      Led a team of 4 engineers to design model thrust
                      structures, improving performance of previous model by
                      594%
                    </li>
                    <li>
                    ...
                    <li>
                      Utilized DonkeyCar software to research deep learning
                      neural networks alongside an internal team of 7 interns
                    </li>
                    <li>
                      Applied operational knowledge of aerospace mechanical
                      systems to design a space debris removal proposal
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section className={style.section}>
                ...
                <div className={style.entry}>
                  ...
                  <p className={style.entryDescription}>
                    Pioneered a digital GUI cookbook catalog with 150+ recipes
                    to meet the design specifications of the client, benefitting
                ...
                <div className={style.entry}>
                  ...
                  <p className={style.entryInfo}></p>
                  <p className={style.entryDescription}>
                    Implemented a file directory archival tool from scratch in C
                    to recreate the Unix tar command in 1.4k lines of code
                  </p>
                </div>
                <div className={style.entry}>
                  <h3 className={style.entryTitle}>
                ...
                <div className={style.entry}>
                  ...
                  <p className={style.entryInfo}></p>
                  <p className={style.entryDescription}>
                    Refactored a deprecated code base for a Forest Path Finder
                    game in Java, reducing redundancy by 48% using OOP
                  </p>
                </div>
                <div className={style.entry}>
                  <h3 className={style.entryTitle}>
                  ...
                  <p className={style.entryDescription}>
                    ...
                    explored future applications of AI in complex predictions
              ...
              <section className={style.section}>
                ...
                <ul className={style.skillList}>
                  <li>
                    ...
                    Assembly, C, JavaFX, JavaScript, HTML, CSS, NodeJS, React
                    Native
                  </li>
                  <li>
                    <strong>Systems/Software: </strong>Git, SVN, Unix, Linux,
                    MacOS
                  </li>
                  <li>
                    <strong>Applications: </strong>Microsoft 365, G-Suite,
                    Systems Tool Kit 12, Android Studio
                  </li>
                  <li>
              ...
              <section className={style.section}>
                ...
                <div className={style.entry}>
                  ...
                  <p className={style.entryInfo}>
                    Contestant and Assitant Coach{" "}
                    <em>February 2020 - Present</em>
                  </p>
                  <ul className={style.entryDescription}>
                    <li>
