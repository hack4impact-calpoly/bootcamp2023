      ...
      <div className="container mx-auto bg-[white]">
        ...
        <div className="px-10 mt-5">
          ...
          <div className="py-2.5">
            ...
            <p className="px-10">
              • Conducted research and deployed a honeypot on newsletter sign-up
              forms, identifying and labeling 3,000 suspected bots within the
              first week of implementation.
            </p>
            <p className="px-10">
              • Contributed to the migration of newsletter sign up and
              confirmation pages from Webflow to Next.js, while also writing an
              accessible carousel and newsletter card component in Typescript.
            </p>
            <p className="px-10">
              • Engaged in competitor newsletter page analysis, providing
              research-based recommendations, and actively contributed to design
              of the newsletter signup and confirmation pages.
            </p>
          </div>
          <div className="py-2.5">
            <div className="flex justify-between px-2.5">
            ...
            <p className="px-10">
              • Refactored login, home, and resource pages by implementing React
              Contexts, enabling seamless data access across multiple pages.
            </p>
          </div>
          <div className="py-2.5">
            <div className="flex justify-between px-2.5">
          ...
          <div className="py-2.5">
            ...
            <p className="px-10">
              • Developed a Snapchat template using React Native, adopted by all
              Snap Academies teams, streamlining instructors' workflow and
              saving approximately 1 week of their time.
            </p>
            <p className="px-10">
          ...
          <div className="py-2.5">
            ...
            <p className="px-10">
              • Tested and validated the functionality and data security of the
              3 integrations using Mocha and Chai.
            </p>
            <p className="px-10">
        ...
        <div className="px-10 mt-5">
          ...
          <p className="text-sm px-2.5">A concept website for a local salon.</p>
        </div>
